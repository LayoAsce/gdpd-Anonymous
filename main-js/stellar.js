...
(function(e, t, n, r) {
    function d(t, n) { this.element = t, this.options = e.extend({}, s, n), this._defaults = s, this._name = i, this.init() } var i = "stellar",
        ...
        a = function() { var t = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/,
                ...
                r = "",
                i; for (i in n)
                if (t.test(i)) { r = i.match(t)[0]; break } return "WebkitOpacity" in n && (r = "Webkit"), "KhtmlOpacity" in n && (r = "Khtml"),
...
(function(d, f, g, b) { if (!d) { console.error("jQuery nÃƒÂ£o encontrado, seu plugin jQuery nÃƒÂ£o irÃƒÂ¡ funcionar."); return false }(function() { var k = 0,
    ...
    function h(k, j) { this._name = e;
        ...
        this.init() } d.extend(h.prototype, { init: function() { var j = this;
            ...
            j.parallaxTranslate() }, parallaxTranslate: function() { var j = this; if (j.inScreen()) { f.requestAnimationFrame(function() { var k = a.scrollTop() - j.$el.offset().top;
                    j.$el.css("transform", "translateY(" + k / 2 + "px)") }) } console.groupEnd() }, destroy: function() { this.$el.removeData();
